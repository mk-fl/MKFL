...
class FedAvg(Strategy):
    ...
    Implementation based on https://arxiv.org/abs/1602.05629 #TODO
    ...
    def __repr__(self) -> str:
        ...
        rep = f"xmk-CKKS FedAvg(accept_failures={self.accept_failures})"
        return rep
    ...
    def aggregate_fit_enc(
        ...
        return parameters_aggregated, metrics_aggregated, n_tot
